...
if ( !function_exists('urna_vc_map_tbay_gallery_instagram') ) {
	function urna_vc_map_tbay_gallery_instagram() {
		...
		vc_map( array(
		    "name" => esc_html__('Urna Gallery Instagram','urna'),
		    "base" => "tbay_gallery_instagram",
		    "icon" => "vc-icon-urna",
		    "class" => "",
	...
	add_action( 'vc_before_init', 'urna_vc_map_tbay_gallery_instagram' );
}

if( class_exists( 'WPBakeryShortCode' ) ){
    class WPBakeryShortCode_tbay_gallery_instagram extends WPBakeryShortCode {}
}
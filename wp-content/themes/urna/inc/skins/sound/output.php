...
$output['footer_heading_color'] 		= array('.tbay-footer .tbay-addon:not(.tbay-addon-newletter) .tbay-addon-title, .tbay-footer .tbay-addon-newletter.tbay-addon .tbay-addon-title');
...
$output['copyright_text_color'] 		= array('.tbay-footer .tbay-copyright .wpb_text_column.wpb_content_element p, .tbay-footer .tbay-addon-newletter.tbay-addon .tbay-addon-title');

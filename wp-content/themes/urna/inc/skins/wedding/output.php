...
$main_color_skin 	= '.has-after:hover,button.btn-close:hover,.new-input + span:before,.new-input + label:before,.header-right .tbay-login > a:hover,.top-wishlist i:hover,.header-right .top-cart .cart-icon i:hover,#tbay-search-form-canvas button:hover , .navbar-nav > li > a:hover,.navbar-nav > li > a:focus,.navbar-nav > li > a:active,.navbar-nav > li:hover > a,.navbar-nav > li:focus > a,.navbar-nav > li.active > a,.tbay-footer .tbay-addon-newletter.tbay-addon .input-group .input-group-btn:hover:after , .tbay-homepage-demo .site-main .tbay-addon .tbay-addon-title > span:not(.subtitle),.tbay-homepage-demo .site-main .tbay-addon .tbay-addon-heading > span:not(.subtitle) , .tbay-addon-testimonials .testimonial-meta .name-client,.tbay-addon-categories .show-all:hover,.product-block.v16 .name a:hover ';  
...
$output['footer_heading_color'] 		= array('.tbay-footer .tbay-addon:not(.tbay-addon-newletter) .tbay-addon-title, .text-black, .tbay-footer .tbay-addon-newletter.tbay-addon .tbay-addon-title');
$output['footer_text_color'] 			= array('.tbay-footer .tbay-addon.tbay-addon-text-heading .description, .contact-info li, .tbay-footer p');
$output['footer_link_color'] 			= array('.tbay-footer .menu li > a, .social.style3 li a, .tbay-footer .wpb_text_column a, .tbay-footer .tbay-addon-newletter.tbay-addon .input-group .input-group-btn:after');
$output['footer_link_color_hover'] 		= array('.tbay-footer .menu li > a:hover, .tbay-footer a:hover, .tbay-footer .social.style3 li a:hover, .tbay-footer .tbay-addon-newletter.tbay-addon .input-group .input-group-btn:hover:after');

/*Custom Copyright*/
$output['copyright_bg'] 				= array(
	'background'=> urna_texttrim('.tbay-footer .tbay-copyright')
);
$output['copyright_text_color'] 		= array('.tbay-footer .tbay-copyright p, .tbay-footer .tbay-addon-newletter.tbay-addon .tbay-addon-title');
$output['copyright_link_color'] 		= array('.tbay-footer .tbay-copyright .wpb_text_column a, .tbay-footer .tbay-addon-newletter.tbay-addon .input-group .input-group-btn:after');
$output['copyright_link_color_hover'] 	= array('.tbay-footer .tbay-copyright .wpb_text_column a:hover, .tbay-footer .tbay-copyright a:hover, .tbay-footer .tbay-addon-newletter.tbay-addon .input-group .input-group-btn:hover:after');

...
$main_color_skin 	= '.has-after:hover,button.btn-close:hover,.new-input + span:before,.new-input + label:before,.top-wishlist i:hover,.cart-dropdown .cart-icon i:hover,.search i:hover,.canvas-menu-sidebar i:hover,.navbar-nav > li > a.active,.navbar-nav > li > a:hover,.navbar-nav > li > a:focus,.navbar-nav > li.active > a,.navbar-nav > li:hover > a,.navbar-nav > li:focus > a,.tbay-footer .menu li > a.active,.tbay-footer .menu li > a:focus,.tbay-footer .menu li:hover > a,.tbay-footer .menu li.active > a,.tbay-footer .menu li:focus > a,.special-testi .tbay-addon-newletter.tbay-addon .input-group .input-group-btn:before,.product-block.v10 .tbay-product-slider-gallery .slick-arrow:hover,.tbay-addon .owl-carousel > .slick-arrow:hover,.tbay-addon .owl-carousel > .slick-arrow:focus,.testimonial-meta > span.name-client,.header-main .tbay-search-form .button-group:before,.tbay-addon.tbay-addon-features .ourservice-heading:hover,#tbay-search-form-canvas.v4 button:hover,#tbay-search-form-canvas.v4 button:hover i,#tbay-search-form-canvas.v4 .sidebar-canvas-search .sidebar-content .select-category .optWrapper .options li:hover label , #tbay-search-form-canvas.v4 .autocomplete-suggestions > div .suggestion-group:hover .suggestion-title';  
